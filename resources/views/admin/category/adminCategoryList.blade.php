    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Product Category <small>Lists</small></h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Alula<small>Product Category Lists</small></h2>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('category.edit',$category->id)}}"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a> 
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Add New Product Category</h4>
                                    </div>
                                        ...
                                        <form action="{{route('category.store')}}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" name="category_name" id="courier_name" required="required" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
