    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Courier <small>Lists</small></h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Couriers <small>Our Best Friend</small></h2>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{route('courier.edit',$courier->id)}}"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a> 
